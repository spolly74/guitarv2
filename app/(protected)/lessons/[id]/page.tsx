...
export default function LessonPage() {
  ...
  // Handle blocks generated by AI - store them as pending
  const handleBlocksGenerated = useCallback((blocks: LessonBlock[]) => {
    setPendingBlocks(blocks)
  }, [])

  // Called when workspace has processed the pending blocks
  const handleBlocksProcessed = useCallback(() => {
    setPendingBlocks([])
  }, [])
    ...
    <ThreePaneLayout
      ...
      centerPane={
        <LessonWorkspace
          ...
          onBlocksProcessed={handleBlocksProcessed}
        />
      }
      rightPane={
        <ChatContainer
